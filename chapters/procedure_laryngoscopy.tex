...
\section*{Overview}
Laryngoscopy is an examination of the back of the throat, including the larynx (voice box) and vocal cords, using a mirror (indirect) or a flexible endoscope (direct). The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
