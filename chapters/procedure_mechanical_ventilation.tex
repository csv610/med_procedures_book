...
\section*{Overview}
Mechanical ventilation is a life-support treatment that helps a patient breathe when they cannot breathe adequately on their own, using a machine (ventilator). The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
