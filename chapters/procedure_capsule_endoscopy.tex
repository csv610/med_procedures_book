...
\section*{Overview}
Capsule endoscopy is a procedure used to record images of the gastrointestinal tract for use in medicine. It utilizes a pill-sized capsule containing a wireless camera. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
\section*{Preparation}
Follow the center's food, drink, and medication instructions. Some centers request fasting and/or a bowel preparation, but the exact plan varies by the capsule study and local protocol. Tell the team about swallowing difficulty, prior bowel obstruction, implanted devices, and pregnancy.
