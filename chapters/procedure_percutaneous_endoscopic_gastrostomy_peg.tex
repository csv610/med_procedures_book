...
\section*{Overview}
Percutaneous endoscopic gastrostomy (PEG) is a procedure that places a feeding tube directly into the stomach through the abdominal wall using endoscopic guidance, for long-term enteral nutrition. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
