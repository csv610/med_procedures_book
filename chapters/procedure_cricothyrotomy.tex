...
\section*{Overview}
Cricothyrotomy is an emergency surgical procedure that opens the cricothyroid membrane to establish a definitive airway when endotracheal intubation is impossible or contraindicated. It provides direct access to the trachea for ventilation and oxygenation. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
