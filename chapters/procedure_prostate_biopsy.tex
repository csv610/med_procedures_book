...
\section*{Overview}
A prostate biopsy removes small tissue cores from the prostate gland using a spring-loaded needle, typically guided by transrectal ultrasound (TRUS) or MRI-fusion. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
