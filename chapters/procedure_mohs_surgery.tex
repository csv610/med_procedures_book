...
\section*{Overview}
Mohs surgery is a tissue-sparing treatment for selected skin cancers. The visible tumor is removed in stages, and each layer is examined microscopically until no cancer cells remain at the edges. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
Active infection at the treatment site, inability to tolerate local anesthesia or positioning, uncontrolled bleeding risk, or serious illness may require postponement or a modified plan. The surgeon reviews anticoagulants and antiplatelet medicines without asking the patient to stop them independently.
