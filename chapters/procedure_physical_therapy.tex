...
\section*{Overview}
Physical therapy is a rehabilitation service that improves movement, strength, balance, endurance, and function after injury, illness, surgery, or disability. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
Therapy is modified or paused for unstable heart or lung disease, acute neurologic change, suspected fracture, uncontrolled pain, fever, or another condition requiring medical assessment. Weight-bearing, range-of-motion, and intensity restrictions must come from the treating team.
