...
\section*{Overview}
Thoracentesis is a procedure that removes fluid from the space between the lung and chest wall (pleural space) through a needle or catheter, for diagnosis and symptom relief. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
