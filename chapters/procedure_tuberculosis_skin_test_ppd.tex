...
\section*{Overview}
The tuberculosis skin test is an intradermal test that checks whether the immune system has reacted to proteins associated with \textit{Mycobacterium tuberculosis}. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
The test is generally avoided after a previous severe reaction to the test or its components. The clinician reviews prior tuberculosis testing, vaccination timing, immunosuppression, and skin conditions that could interfere with placement or reading; the test does not diagnose active tuberculosis by itself.
