...
\section*{Overview}
ESWL uses shock waves generated outside the body to break kidney or ureteral stones into tiny fragments (sand) that can then pass naturally in the urine. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
