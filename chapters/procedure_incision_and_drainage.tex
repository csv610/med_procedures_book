...
\section*{Overview}
Incision and drainage (I\&D) is a minor surgical procedure to release pus from an abscess, boil, or infected cyst. It relieves pressure, reduces pain, and allows the infection to heal. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
