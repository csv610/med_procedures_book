...
\section*{Overview}
Bronchoscopy uses a viewing tube to examine the voice box, windpipe, and branching airways. A flexible bronchoscope is most common; a rigid bronchoscope or additional tools may be selected when the goal is to control bleeding, remove an obstruction, obtain samples, or treat an airway problem.
