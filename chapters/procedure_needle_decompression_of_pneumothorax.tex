...
\section*{Overview}
Needle decompression of pneumothorax is an emergency procedure in which a large-bore needle or catheter is inserted into the pleural space to release trapped air. It is the immediate, temporizing treatment for tension pneumothorax. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
