...
\section*{Overview}
Sentinel node biopsy is a procedure that identifies and removes the first lymph node or nodes that drain a cancer, most often in breast cancer and melanoma, to stage the disease. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
