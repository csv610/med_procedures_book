...
\section*{Overview}
Pericardiocentesis is a procedure that uses a needle and catheter to remove fluid from the pericardial sac around the heart, either for diagnosis or to relieve cardiac tamponade. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
