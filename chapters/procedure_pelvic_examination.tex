...
\section*{Overview}
A pelvic examination assesses the external and internal reproductive organs, including the vulva, vagina, cervix, uterus, and adnexa. It may be part of routine care or an evaluation of symptoms. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
A pelvic examination should be deferred or modified for severe pain, active trauma, acute infection requiring urgent treatment, or when the patient does not consent. The clinician should explain the examination, offer privacy and a chaperone according to local policy, and stop if the patient asks.
