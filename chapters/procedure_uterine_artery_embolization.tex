...
\section*{Overview}
Uterine artery embolization (UAE), also called uterine fibroid embolization (UFE), is a minimally invasive procedure that blocks blood flow to uterine fibroids to shrink them and relieve symptoms. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
