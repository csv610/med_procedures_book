...
\section*{Overview}
Gastric lavage is the washing out of the stomach using a large-bore tube with instillation and aspiration of fluid. It is used to remove ingested toxins or to manage gastrointestinal bleeding. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
