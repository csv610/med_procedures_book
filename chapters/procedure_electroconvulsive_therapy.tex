...
\section*{Overview}
Electroconvulsive therapy (ECT) is a treatment that delivers a controlled electrical stimulus to the brain to induce a brief, generalized seizure, used for severe psychiatric disorders. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
