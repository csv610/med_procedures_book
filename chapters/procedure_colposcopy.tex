...
\section*{Overview}
Colposcopy uses a specialized magnifying instrument (colposcope) to inspect the cervix, vagina, and vulva for abnormal cells, typically guided by applying acetic acid. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
