...
\section*{Overview}
Cardiac ablation uses heat (radiofrequency) or cold (cryoablation) energy to scar tiny areas in the heart that are creating or conducting irregular electrical signals, thereby restoring normal sinus rhythm. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
