...
\section*{Overview}
Tonometry measures intraocular pressure, the pressure of fluid inside the eye. It is an important part of evaluating and monitoring glaucoma and other eye conditions. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
Noncontact tonometry has few contraindications. Contact methods may need to be avoided or modified with corneal injury, active eye infection, recent eye surgery, or inability to keep the eye still. The clinician chooses the method and interprets the result with the rest of the eye examination.
