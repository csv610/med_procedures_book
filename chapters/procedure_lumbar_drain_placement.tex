...
\section*{Overview}
A lumbar drain is a small catheter inserted into the lumbar subarachnoid space to continuously drain cerebrospinal fluid (CSF) to lower intracranial pressure or manage CSF leaks. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
