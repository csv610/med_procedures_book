...
\section*{Overview}
Cardioversion restores a normal heart rhythm in people with certain types of abnormal heartbeats (arrhythmias), usually by delivering a synchronized electrical shock through electrode pads on the chest. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
