...
\section*{Overview}
Normal labor and vaginal delivery is the process by which uterine contractions open the cervix and the baby is delivered through the vagina, followed by delivery of the placenta. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
...
Vaginal delivery may be unsafe with certain placental, fetal-position, maternal, or fetal conditions, or when urgent operative delivery is required. The obstetric team continually reassesses labor and may change the plan; a single checklist cannot determine eligibility.
