...
\section*{Overview}
Sigmoidoscopy uses a flexible scope to examine only the rectum and the lower part of the colon (sigmoid colon), which constitutes the distal third of the large intestine. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
