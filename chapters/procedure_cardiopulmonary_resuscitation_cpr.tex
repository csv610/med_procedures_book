...
\section*{Overview}
CPR is an emergency procedure that combines chest compressions and artificial ventilation to manually preserve brain function and circulation in a person in cardiac arrest. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
