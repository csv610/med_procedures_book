...
\section*{Overview}
Percutaneous lung biopsy is a procedure that uses a needle through the chest wall to sample a lung nodule or mass for diagnosis. The exact approach, setting, and preparation depend on the indication, anatomy, and the patient's health.
